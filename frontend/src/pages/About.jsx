  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content=" Psikolog Alara Okul hakkında bilgi. 6 yıllık deneyim, uzmanlık alanları ve yaklaşımları."
        />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                BDT Yaklaşımı, Şema Yaklaşımı ve EMDR gibi kanıta dayalı yöntemlerini
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Kanıta dayalı yöntemler ile ruh sağlığınızı destekliyorum
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="card text-center">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900">BDT Yaklaşımı</h3>
            ...
            <div className="card text-center">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900">Şema Yaklaşımı</h3>
              <p className="text-gray-600">
            ...
            <div className="card text-center">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900">EMDR</h3>
              <p className="text-gray-600">
            ...
            <div className="card text-center">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900">Bireysel görüşme</h3>
              <p className="text-gray-600">
            ...
            <div className="card text-center">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900">Aile danışmanlığı</h3>
              <p className="text-gray-600">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="card">
              <h3 className="text-xl font-semibold mb-4 text-primary-600">Yaklaşımlar</h3>
              <ul className="space-y-3">
                <li className="flex items-start">
